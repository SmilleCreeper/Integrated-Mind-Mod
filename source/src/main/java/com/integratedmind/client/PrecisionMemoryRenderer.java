...
import com.integratedmind.PrecisionMemoryBlock;
import com.integratedmind.PrecisionMemoryBlockEntity;
...
public class PrecisionMemoryRenderer implements BlockEntityRenderer<PrecisionMemoryBlockEntity> {
    private final Font font;

    public PrecisionMemoryRenderer(BlockEntityRendererProvider.Context context) {
        this.font = context.getFont();
    }

    @Override
    public void render(PrecisionMemoryBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        ...
        if (!(state.getBlock() instanceof PrecisionMemoryBlock)) return;

        Direction facing = state.getValue(PrecisionMemoryBlock.FACING);
